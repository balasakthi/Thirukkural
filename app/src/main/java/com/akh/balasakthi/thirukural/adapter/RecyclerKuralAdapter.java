...
import com.akh.balasakthi.thirukural.MainActivity;
...
public class RecyclerKuralAdapter extends RecyclerView.Adapter<RecyclerKuralAdapter.MyViewHolder> {

    private List<Thirukural> thirukuralList;
    private Context context;
    private List<Thirukural> thirukuralCpyList;
    private String mSearchText = "";
    private String lang = MainActivity.langToloadKural;

    public RecyclerKuralAdapter(Context context, List<Thirukural> thirukuralList) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView kuralNoTxtView, KuralTxtView, chapterTxtView;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.kural_recyclerview, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (lang.equalsIgnoreCase("en")) {
            holder.kuralNoTxtView.setText("Couplet: " + Integer.toString(thirukural.getKural_id()));
            ...
            holder.kuralNoTxtView.setText("குறள்: " + Integer.toString(thirukural.getKural_id()));
